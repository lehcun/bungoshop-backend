...
async function main() {
  ...
  await prisma.promotionOnProduct.deleteMany(); // add them
    ...
    data: [
      {
        name: 'Shoes',
        iconUrl:
          'https://res.cloudinary.com/dbvlsf9bi/image/upload/v1760551378/sneakers_wfjy9n.png',
      },
      {
        name: 'Clothes',
        iconUrl:
          'https://res.cloudinary.com/dbvlsf9bi/image/upload/v1760550394/clothes_xvozll.png',
      },
      {
        name: 'Accessories',
        iconUrl:
          'https://res.cloudinary.com/dbvlsf9bi/image/upload/v1760551387/accessories_cssiht.png',
      },
      {
        name: 'Bags',
        iconUrl:
          'https://res.cloudinary.com/dbvlsf9bi/image/upload/v1760551369/bag_lx7l96.png',
      },
      {
        name: 'Electronics',
        iconUrl:
          'https://res.cloudinary.com/dbvlsf9bi/image/upload/v1760551361/electronics_epdnnf.png',
      },
    ],
    skipDuplicates: true,
  });
  ...
  if (favoritesData.length > 0) {
    await prisma.favourite.createMany({ data: favoritesData });
